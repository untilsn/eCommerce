    ...
    <div className="py-20 border-t border-gray border-opacity-20">
      <div className="container grid grid-cols-4 gap-10 ">
        <div className="flex flex-col gap-5">
          ...
          <p className="text-lg text-gray text-opacity-60">
          ...
          <div className="flex items-center gap-5 p-5 border border-gray border-opacity-20">
            ...
            <div>
              <div className="text-lg text-gray text-opacity-60">
                Got Question? Call us 24/7
              </div>
              <span className="text-2xl">+0123 456 789</span>
            </div>
          </div>
        </div>
        <div>
          ...
          <ul className="flex flex-col gap-3 mt-8">
            <li>
              <a
                className="text-lg hover:text-yellow text-gray text-opacity-70"
                href="#"
              >
                About Molla
              </a>
